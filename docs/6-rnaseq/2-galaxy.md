...
![]({{ '/assets/img/rnaseq/bowtie.png' | relative_url }})
...
![]({{ '/assets/img/rnaseq/coverage.png' | relative_url }})
...
![]({{ '/assets/img/rnaseq/browser1.png' | relative_url }})

![]({{ '/assets/img/rnaseq/browser2.png' | relative_url }})
...
![]({{ '/assets/img/rnaseq/cuffdiff.png' | relative_url }})
