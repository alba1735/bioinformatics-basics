...
Unix is an operating system. Pretty much all servers (as opposed to personal computers) run a variant of Unix. Anyone with a UCSC account can access the computing server Hummingbird. [See more details here](https://www.hb.ucsc.edu/){:target="blank"}.
...
- PuTTy. It's the classic way to `ssh` and has been around since before computers were invented. [Download](https://www.putty.org/){:target="blank"}
- Cygwin
- Windows PowerShell.
- Other options?
...
No personal experience, but it appears you can install a version of Ubuntu using Crouton - [see this page](https://ubuntu.com/tutorials/install-ubuntu-on-chromebook#1-overview){:target="blank"} for instructions (or Google, for multiple tutorials)
...
[Android](https://play.google.com/store/apps/details?id=com.sonelli.juicessh&hl=en_US){:target="blank"}

[iOS](https://apps.apple.com/us/app/termius-ssh-client/id549039908){:target="blank"}
